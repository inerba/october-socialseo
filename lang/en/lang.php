<?php return [
    'plugin' => [
        'name' => 'SocialSEO Extension',
        'description' => 'Provide SEO & Social meta to October CMS Pages, Static Pages, Blog post',
    ],
    'editor' => [
        ...
        'robot' => 'Robots',
        'social' => [
            'fb_description' => 'Facebook post',
            'tw_description' => 'Tweet',
            'social_image' => 'Image for facebook post and twitter card'
        ]
    ],
    'settings' => [
        'label' => 'SEO Extension',
